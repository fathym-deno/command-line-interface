...
Deno.test('CommandIntent wrapper accepts CommandModuleBuilder', () => {
  const intentBuilder = CommandIntent('wrapper single', builder as any, './test-cli/.cli.json');
...
Deno.test('CommandIntents wrapper accepts CommandModuleBuilder', () => {
  const intentsBuilder = CommandIntents('wrapper suite', builder as any, './test-cli/.cli.json');
